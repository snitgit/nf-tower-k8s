...
This guides shows how to configure a container based NFS server used for demoing purpose.

__NOTE__: DO NOT USE THIS FOR PRODUCTION DEPLOYMENT.

Copy and paste the following Kubernetes resources definition in your shell terminal
...
of the Tower compute environment.
